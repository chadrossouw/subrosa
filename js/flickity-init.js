...
elem.forEach((element)=>{
  ...
  if(element.classList.contains('gallery--post') && element.nextElementSibling.classList.contains('gallery_nav')){
  ...
  if(nav){
    var navFlkty = new Flickity (nav,navOptions);
  }
...
const galleryCaption = document.querySelectorAll('.picture_gallery_caption');
galleryCaption.forEach(caption=>caption.addEventListener('click',toggleOpen));
}
